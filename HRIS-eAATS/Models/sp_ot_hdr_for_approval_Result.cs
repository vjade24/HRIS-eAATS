...
namespace HRIS_eAATS.Models
{
    ...
    public partial class sp_ot_hdr_for_approval_Result
    {
        ...
        public string ot_for_employee_name { get; set; }
        public string ot_thru_empl_id { get; set; }
        public string ot_thru_employee_name { get; set; }
        public string ot_from_empl_id { get; set; }
        public string ot_from_employee_name { get; set; }
        public string ot_requestor_empl_id { get; set; }
        public string ot_requestor_employee_name { get; set; }
