...
namespace BioMetrixCore
{
    internal class DeviceManipulator
    {
        ...
        public ICollection<UserInfo> UploadAllUserInfo(ZkemClient objZkeeper, int machineNumber,int dest_machineNumber,string ipAddress)
        {
            ...
            if (objZkeeper.Connect_Net(ipAddress, 4370))
            {
               if(UploadFTPTemplate(objZkeeper, dest_machineNumber, lstUserInfo))
                {
        ...
        public ICollection<MachineInfo> GetLogData(ZkemClient objZkeeper, int machineNumber, DateTime startdate, DateTime lastdate, string empl_id)
        {
        ...
        public ICollection<UserIDInfo> GetAllUserID(ZkemClient objZkeeper, int machineNumber)
        {
            ...
            while (objZkeeper.GetAllUserID(machineNumber, ref dwEnrollNumber, ref dwEMachineNumber, ref dwBackUpNumber, ref dwMachinePrivelage, ref dwEnabled))
            {
                ...
                userID.BackUpNumber = dwBackUpNumber.ToString();
                userID.Enabled = dwEnabled.ToString();
                userID.EnrollNumber = dwEnrollNumber.ToString();
                userID.MachineNumber = dwEMachineNumber.ToString();
                userID.Privelage = dwMachinePrivelage.ToString();
        ...
        //internal ICollection<MachineInfo> GetLogData(ZkemClient objZkeeper, int machineNumber, DateTime? startdate, DateTime? lastdate)
        //{
