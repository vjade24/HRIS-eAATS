...
namespace BioMetrixCore
{
    public class ZkemClient : IZKEM
    {
        ...
        {
            var SSR_SetUserInfo = objCZKEM.SSR_SetUserInfo(dwMachineNumber, dwEnrollNumber, Name, Password, Privilege, Enabled);
            return SSR_SetUserInfo;
        }
        ...
        {
            if (objCZKEM.SetEnrollData(dwMachineNumber, dwEnrollNumber, dwEMachineNumber, dwBackupNumber, dwMachinePrivilege, ref dwEnrollData, dwPassWord))
            {
                return true;
            }
            else
